...
// An abstract class representing a means for heap sort to be used in the gui.
abstract class SortingHeapSort<T> implements SortAlgorithm<T> {
     ...
     * <code>Comparator</code>. Return the sorted result. For <em>in-place</em>
     * algorithms <code>alist</code> should be the result.
     * 
     * @param alist
     *            the <code>ArrayList</code> to sort
     * @param comp
     *            the <code>Comparator</code> that determines the ordering
